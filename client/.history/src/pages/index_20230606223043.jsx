...
export default function Home() {
  ...
  return (
    <>
      {cookie ? (
        <Layouts>
          <Layout style={{ minHeight: "100%", borderRadius: "20px", display: "flex", alignItems: "center", justifyContent: "center" }}>
            <h1 className="font-bold text-2xl ml-auto px-4 my-6 border-r-[4px] border-r-[#0092ff]">הפרופיל שלי</h1>
            <div className="flex items-center justify-center flex-col w-full md:w-[60vw] md:h-[50vh] h-min-[50vh] shadow-2xl">
              ...
              <Button type="submit" label="שמור שינויים" className={"w-10/12 mb-6"} />
            </div>
          </Layout>
        </Layouts>
      ) : (
