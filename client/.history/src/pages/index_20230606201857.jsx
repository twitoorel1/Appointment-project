      ...
      {cookie ? (
        <Layouts>
          <Layout style={{ minHeight: "100%", backgroundColor: "white", borderRadius: "20px", display: "flex", alignItems: "center", justifyContent: "center" }}>
            ...
            <div className="flex items-center justify-evenly w-full md:flex-row flex-col">
              <Image src={"/avatar/avatar.jpg"} width={150} height={150} className="w-full md:w-[250px]" />
              <div className="flex items-center justify-evenly w-full md:flex-row flex-col">
                <Input inputClassName={"md:w-[250px]"} variant="default" type="text" value={user?.phone} label="טלפון" showLabel />
                <Input inputClassName={"md:w-[250px]"} variant="default" type="text" value={user?.address} label="כתובת" showLabel />
              </div>
            </div>
          </Layout>
        </Layouts>
