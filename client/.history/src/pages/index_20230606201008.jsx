        ...
        <Layouts>
          <Layout style={{ minHeight: "100%", backgroundColor: "white", borderRadius: "20px", display: "flex", alignItems: "center", justifyContent: "center" }}>
            ...
            <div className="flex items-center justify-center flex-col md:flex-row bg-green-400 w-full md:w-[60vw] md:h-[50vh] h-min-[50vh] shadow-2xl">
              <div>
                <Input type="text" placeholder={user?.firstName} value="ss" label="שם פרטי" showLabel />
                <Input type="text" placeholder={user?.lastName} label="שם משפחה" showLabel />
              </div>
              <div>
                <Input type="text" placeholder={user?.username} label="שם משתמש" showLabel />
                <Input type="text" placeholder={user?.email} label="אימייל" showLabel />
              </div>
            </div>
          </Layout>
        </Layouts>
