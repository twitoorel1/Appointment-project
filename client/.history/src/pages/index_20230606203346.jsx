        ...
        <Layouts>
          <Layout style={{ minHeight: "100%", backgroundColor: "white", borderRadius: "20px", display: "flex", alignItems: "center", justifyContent: "center" }}>
            ...
            <div className="flex items-center justify-center flex-col bg-green-400 w-full md:w-[60vw] md:h-[50vh] h-min-[50vh] shadow-2xl">
              ...
              <div className="bg-blue-400 block relative">
                <Image className="object-fill w-36 h-36 rounded-full custom-position" src={"/avatar/avatar.jpg"} width={50} height={50} alt="Profile Image" />
              </div>
              ...
              {/* <a href="#" className="block relative">
                <img
                  ...
                  className="object-fill w-36 h-36 rounded-full custom-position" />
              </a> */}
