          ...
          <Layout style={{ minHeight: "100%", backgroundColor: "white", borderRadius: "20px", display: "flex", alignItems: "center", justifyContent: "center" }}>
            ...
            <div className="flex items-center justify-center flex-col bg-green-400 w-full md:w-[60vw] md:h-[50vh] h-min-[50vh] shadow-2xl">
              <div className="flex items-center justify-evenly bg-black w-full">
                <Input va type="text" value={user?.firstName} label="שם פרטי" showLabel />
                <Input va type="text" value={user?.lastName} label="שם משפחה" showLabel />
              </div>
              <div className="flex items-center justify-evenly bg-black w-full">
                <Input va type="text" value={user?.username} label="שם משתמש" showLabel />
                <Input va type="text" value={user?.email} label="אימייל" showLabel />
              </div>
            </div>
          </Layout>
        </Layouts>
