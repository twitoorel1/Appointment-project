        ...
        <Layouts>
          <Layout style={{ minHeight: "100%", backgroundColor: "white", borderRadius: "20px", display: "flex", alignItems: "center", justifyContent: "center" }}>
            ...
            <div className="flex items-center justify-center flex-col bg-green-400 w-full md:w-[60vw] md:h-[50vh] h-min-[50vh] shadow-2xl">
              ...
              {/* 
              <div className="bg-blue-400 rounded-full w-96 h-96">
                <Image src={"/avatar/avatar.jpg"} width={50} height={50} />
              </div> */}
              <div class="w-11 h-11 shrink-0 grow-0 rounded-full bg-green-300 text-green-700 object-cover">
                <Image src={"/avatar/avatar.jpg"} width={50} height={50} className="" />
              </div>
              <div class="avatar aspect-square rounded-full">sva</div>
            </div>
          </Layout>
        </Layouts>
      ) : (
