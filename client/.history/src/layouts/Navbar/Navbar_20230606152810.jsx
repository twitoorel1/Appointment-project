...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <Layout>
        <Header style={{ padding: 0, backgroundColor: "transparent", display: "flex", alignItems: "center" }}>
          <Button variant="primary" className=" bg-white text-black p-5" >שלום, {user.firstName} {user.lastName}
            <DownOutlined /></Button>
        </Header>
